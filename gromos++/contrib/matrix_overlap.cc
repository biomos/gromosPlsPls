 ...
 * between two matrices. Considering the following definition for the
 ...
 * calculated according to the following steps. Consider a matrix A, first the
 * matrix is diagonalized
 *
 * @f[ T = V^{-1} A V @f]
 *
 * Second, the square root of the diagonal matrix is taken. This procedure
