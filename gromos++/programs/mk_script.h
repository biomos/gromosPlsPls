...
class iangleres {
public:
  int found, ntalr, ntwalr;
  double calr, thelin, tolbac;
...
std::istringstream & operator>>(std::istringstream &is, iangleres &s) {
  ...
  readValue("ANGLERES", "THELIN", is, s.thelin, ">0");
