 ...
 * It reads in energy time series generated by ene_ana. It provides an  error
...
int main(int argc, char** argv) {
  ...
  try {
    ...
    vector<gmath::Stat< double> > allexphxhr2;
    ...
    for (Arguments::const_iterator
      ...
      while (true) {
        ...
        exphxhr2.addval(exp((-(hx - hr) / (gmath::boltz * temp))));
      }
      ...
      allexphxhr2.push_back(exphxhr2);
