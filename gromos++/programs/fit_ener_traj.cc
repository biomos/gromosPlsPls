...
try{
  ...
  Boundary *pbcfit = BoundaryParser::boundary(fitsys, args, "fitpbc");
  //parse gather method
  Boundary::MemPtr gathmethod = args::GatherParser::parse(sys, sys, args);
  Boundary::MemPtr fitgathmethod = args::GatherParser::parse(fitsys, fitsys, args, "fitpbc");
