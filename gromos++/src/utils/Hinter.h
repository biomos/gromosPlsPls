...
void Intermolecular(const Arguments &args, int m1, int m2, double time, double dt, double maxdist, double minangle){
//  read topology
   args.check("topo",1);
 ...
 cout << "Doing an INTERmolecular H-bond analysis using molecule" << m1+1
      << " and " << m2+1   
