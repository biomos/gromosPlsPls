...
namespace args {
   ...
   * <tr><td>pqr [&lt;factor to convert length unit to Angstrom, 10.0&gt; and/or &lt;"renumber" keyword to start numbering at 1 at each molecule&gt;] </td><td>Modified Protein Data Bank (PDB) format.</td></tr>
